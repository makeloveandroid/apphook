...
class MethodHook : BaseHook {
    ...
    var isHookAll = false
    var isCallOne = false
    var isCallBefore = false
    var isCallAfter = false
    ...
    constructor(builder: Builder) {
        ...
        this.isCallOne = builder.isCallOne
    ...
    override fun execute() {
        ...
        parameterTypesAndCallback[parameterTypes.size] = object :
            ...
            override fun beforeHookedMethod(param: MethodHookParam?) {
                ...
                if (isCallOne && isCallBefore) return
                isCallBefore = true
                try {
            ...
            override fun afterHookedMethod(param: MethodHookParam?) {
                ...
                if (isCallOne && isCallAfter) return
                isCallAfter = true
                try {
    ...
    open class Builder {
        ...
        fun isCallOne(isCallOne: Boolean): Builder {
            this.isCallOne = isCallOne
            return this
        }
