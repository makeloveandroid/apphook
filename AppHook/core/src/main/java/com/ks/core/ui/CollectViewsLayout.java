...
public class CollectViewsLayout extends View {
    ...
    private final int halfEndPointWidth = dp2px(2.5f);
    private final int textBgFillingSpace = dp2px(2);
    private final int textLineDistance = dp2px(5);
    ...
    protected Paint dashLinePaint = new Paint() {
        {
            ...
            setPathEffect(new DashPathEffect(new float[]{dp2px(4), dp2px(8)}, 0));
        }
    };
    ...
    protected void onAttachedToWindow() {
        ...
        try {
            final Activity targetActivity = ActivityUtils.getTopActivity();
            ...
            if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN) {
                ...
                if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.M) {
                    ...
                    ReflectionP.breakAndroidP(new ReflectionP.Func<Object>() {
                        @Override
                        public Object call() {
                            try {
    ...
    public static String px2dip(float pxValue, boolean withUnit) {
        return px2dp(pxValue) + (withUnit ? "dp" : "");
    }
}
